...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Find and Map Cases", None))
        self.pushButton_2.setText(_translate("MainWindow", "Pair Cases", None))
        self.pushButton_3.setText(_translate("MainWindow", "Update Data", None))
        self.pushButton_4.setText(_translate("MainWindow", "Delete Case", None))
